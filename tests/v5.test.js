...
T('transmissionTexte — constantes, obs, événement, plaie : texte lisible sans « undefined »',()=>{
  ...
  for(const morceau of ['Mme T.','IDE AL','TA 13/8','FC 72','Glycémie 1,05','douleur EVA 4-6','chute','peau : rougeur','ÉVÉNEMENT : CHUTE','chute nocturne','Moral en baisse.','Réfection Talon G','Fibrineux','Injection d\'insuline'])
